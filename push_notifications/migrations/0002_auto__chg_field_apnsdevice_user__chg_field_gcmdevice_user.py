    ...
    models = {
        ...
        u'push_notifications.apnsdevice': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'to': u"orm['accounts.User']", 'null': 'True', 'blank': 'True'})
        },
